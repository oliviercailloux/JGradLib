...
public class TestGitHubIssue {
	...
	public void testAssignees() throws Exception {
		...
		assertEquals("https://github.com/badga/Collaborative-exams/issues/3", issue.getBare().getHtmlURL().toString());
	...
	public void testHist() throws Exception {
		...
		assertEquals(Utils.newURL("https://github.com/oliviercailloux/testrel/issues/2"), issue.getBare().getHtmlURL());
	...
	public void testOpen() throws Exception {
		...
		final IssueWithHistory issue = factory.getIssue(coord);
		LOGGER.info("Issue: {}.", issue);
		assertEquals(Utils.newURL("https://github.com/oliviercailloux/testrel/issues/3"), issue.getBare().getHtmlURL());
