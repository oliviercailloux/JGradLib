...
public enum ExJpaCriterion implements Criterion {
	...
	GROUP_ID("Group id follows Maven best practices", 0d, -0.5d),
	JUNIT5_DEP("JUnit 5 (recent and correct) dependency", 0.5d), UTF("Encoding property", 0d, -0.5d),
	...
	ASSERT_EQUALS(
			"Unit test uses appropriate JUnit 5 constructs (or Arquillian) and tests the right thing (manual correction)",
			2d),
