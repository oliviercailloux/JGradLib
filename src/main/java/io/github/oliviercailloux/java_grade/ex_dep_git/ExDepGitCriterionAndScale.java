...
public enum ExDepGitCriterionAndScale implements CriterionAndPoints {
	...
	private ExDepGitCriterionAndScale(String requirement, double maxPoints) {
		this(requirement, maxPoints, 0d);
	}

	private ExDepGitCriterionAndScale(String requirement, double maxPoints, double minPoints) {
