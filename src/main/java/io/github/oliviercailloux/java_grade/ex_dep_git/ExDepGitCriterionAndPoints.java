...
public enum ExDepGitCriterionAndPoints implements CriterionAndPoints {
	...
	private ExDepGitCriterionAndPoints(String requirement, double maxPoints) {
		this(requirement, maxPoints, 0d);
	}

	private ExDepGitCriterionAndPoints(String requirement, double maxPoints, double minPoints) {
