...
/**
 * A mark aggregator that is able to obtain weights using criteria only, thus with no needs of the
 * marks. This is of great value as it permits to know the weights of the tree without having a
 * marks tree. Thus, an aggregation tree using only criteria weighters is guaranteed to give an
 * equal tree of weights for any two compatible mark tree, provided the two mark trees represent
