 ...
 * <p>
 * Some instances reject some sets of criteria, for example, an aggregator using static weights
 * given an unknown criterion; or a parametric weighter given more than one unknown criterion.
