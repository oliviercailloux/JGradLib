...
/**
 * TODO a student may have an overriding mark, example, student was absent but
 * submitted anyway, we want to give 0 but still give the information about the
 * counterfactual grade.
 *
 * So in fact any tree may be added an overriding mark, and this still conforms
 * to the same aggregation procedure, it seems? (In the sense of being the same
 * exam.)
 */
