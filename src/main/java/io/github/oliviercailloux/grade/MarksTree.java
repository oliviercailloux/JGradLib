...
/**
 * A tree of criteria paths with marks; with no aggregation information, thus, no marks at non-leaf
 * nodes.
 * <p>
 ...
 * <p>
 * Generally goes logically together with a GradeAggregator (because similar structures are required
 * for aggregation to be possible), but code may be simpler with a grade object alone; and this
 * class may be useful for more fundamental purposes such as collecting marks given by various
