...
/**
 * A simulator of a very simple variant of the
 * <a href="https://fr.wikipedia.org/wiki/421_(jeu)">421 dice game</a>. In this
 * variant, we simply attempt to roll the dice in hope of obtaining 421,
...
public interface Game421 {
	...
	/**
	 * Attempts to obtain 421 by throwing the (triplet of) dice at most the
	 * indicated number of times.
	 *
	 * @param nbTries the number of attempts after which to stop trying, if 421 has
