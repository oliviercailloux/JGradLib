...
/**
 * A redundancy counter is linked to some manager that contains elements (such
 * as persons) and permits to retrieve the number of duplicated elements and the
 * number of unique elements that have been set in that manager.
 *
 */
