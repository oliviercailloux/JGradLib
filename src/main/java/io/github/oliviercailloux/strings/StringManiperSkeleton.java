...
public class StringManiperSkeleton {
   ...
   * <p>
   * For example, given an original string "blah" and a prefix "pp", this method returns "ppblah".
   *
  ...
  public static String prefixOnce(String prefix, String original) {
    /*
     * The return expression below is incorrect and is there only to allow this class to compile.
     */
    return "";
  }

  /**
   * Returns the given original string, prefixed with as many repetitions of the prefix as
   * requested.
   * <p>
   * For example, given an original string “blah” and a prefix “42” and repetitions equal to 3, this
   * method returns “424242blah”.
   *
   * @param prefix the prefix
   * @param repetitions the number of repetitions of the prefix
   * @param original the original string
   * @return the original string, prefixed.
   * @throws IllegalArgumentException if <code>repetitions</code> is strictly negative
   */
   ...
   * @throws IllegalStateException if the suffix set previously is <code>null</code> or empty
   */
